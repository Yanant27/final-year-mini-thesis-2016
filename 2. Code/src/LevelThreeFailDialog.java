...
public class LevelThreeFailDialog extends JDialog
{
	...
	JLabel jlbText=new JLabel("Level Three Failed !",SwingConstants.CENTER);
	...
	JLabel jlbTargetScore=new JLabel("Target Score : 90");
	JLabel jlbPlayerScore=new JLabel();
	
	public LevelThreeFailDialog(String name, int score)
	{
		this(null,true,name,score);
	}
	public LevelThreeFailDialog(Frame parent, boolean modal, String name, int score)
	{
		super(parent,modal);
		setTitle("Level Three Fail");
	...
	{
		LevelThreeFailDialog dialog=new LevelThreeFailDialog("hello",00);

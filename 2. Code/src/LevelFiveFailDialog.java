...
public class LevelFiveFailDialog extends JDialog
{
	...
	JLabel jlbText=new JLabel("Level Five Failed !",SwingConstants.CENTER);
	...
	public LevelFiveFailDialog(String name, int score)
	{
		this(null,true,name,score);
	}
	public LevelFiveFailDialog(Frame parent, boolean modal, String name, int score)
	{
		super(parent,modal);
		setTitle("Level Five Fail");
	...
	{
		LevelFiveFailDialog dialog=new LevelFiveFailDialog("hello",00);

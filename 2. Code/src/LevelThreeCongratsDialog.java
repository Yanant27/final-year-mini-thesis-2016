...
public class LevelThreeCongratsDialog extends JDialog{
	...
	JLabel jlbText=new JLabel("Level Three Passed !");
	JLabel jlbTargetScore=new JLabel("Target Score : 90");
	JLabel jlbPlayerScore=new JLabel();
	
	public LevelThreeCongratsDialog(String name, int score)
	{
		this(null,true,name,score);
	}
	public LevelThreeCongratsDialog(Frame parent, boolean modal, String name, int score)
	{
		super(parent,modal);
	...
	{
		LevelThreeCongratsDialog dialog=new LevelThreeCongratsDialog("hello",00);

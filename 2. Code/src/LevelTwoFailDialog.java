...
public class LevelTwoFailDialog extends JDialog
{
	...
	JLabel jlbText=new JLabel("Level Two Failed !",SwingConstants.CENTER);
	...
	public LevelTwoFailDialog(String name, int score)
	{
		this(null,true,name,score);
	}
	public LevelTwoFailDialog(Frame parent, boolean modal, String name, int score)
	{
		super(parent,modal);
		setTitle("Level Two Fail");
	...
	{
		LevelTwoFailDialog dialog=new LevelTwoFailDialog("hello",00);

...
public class LevelOneCongratsDialog extends JDialog{
	...
	JLabel jlbText=new JLabel("Level One Passed !");
	JLabel jlbTargetScore=new JLabel("Target Score : 25");
	JLabel jlbPlayerScore=new JLabel();
	
	public LevelOneCongratsDialog(String name, int score)
	{
		this(null,true,name,score);
	}
	public LevelOneCongratsDialog(Frame parent, boolean modal, String name, int score)
	{
		super(parent,modal);
